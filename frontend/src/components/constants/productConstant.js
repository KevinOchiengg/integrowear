...
export const PRODUCT_SAVE_REQUEST = 'PRODUCT_LIST_REQUEST';
export const PRODUCT_SAVE_SUCCESS = 'PRODUCT_LIST_SUCCESS';
export const PRODUCT_SAVE_FAIL = 'PRODUCT_LIST_FAIL';
